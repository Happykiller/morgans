...
import copyEn from './FitdeskAcceptInviteFromCoachToNoExistingAthlete.en.json';
import copyFr from './FitdeskAcceptInviteFromCoachToNoExistingAthlete.fr.json';

type SupportedLocale = 'fr' | 'en';

interface FitdeskAcceptInviteFromCoachToNoExistingAthleteProps {
  locale?: string;
}
...
export default function FitdeskAcceptInviteFromCoachToNoExistingAthlete({
  locale = 'fr',
}: FitdeskAcceptInviteFromCoachToNoExistingAthleteProps) {
