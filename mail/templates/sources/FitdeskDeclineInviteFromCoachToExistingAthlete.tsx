...
import copyEn from './FitdeskDeclineInviteFromCoachToExistingAthlete.en.json';
import copyFr from './FitdeskDeclineInviteFromCoachToExistingAthlete.fr.json';

type SupportedLocale = 'fr' | 'en';

interface FitdeskDeclineInviteFromCoachToExistingAthleteProps {
  locale?: string;
}
...
export default function FitdeskDeclineInviteFromCoachToExistingAthlete({
  locale = 'fr',
}: FitdeskDeclineInviteFromCoachToExistingAthleteProps) {
