...
import copyEn from './FitdeskInviteFromCoachToExistingAthlete.en.json';
import copyFr from './FitdeskInviteFromCoachToExistingAthlete.fr.json';

type SupportedLocale = 'fr' | 'en';

interface FitdeskInviteFromCoachToExistingAthleteProps {
  locale?: string;
}
...
interface InviteCopy {
  ...
  intro: string;
  coachCardLabel: string;
  coachIdentityLabel: string;
  responseMethodLabel: string;
  validityLabel: string;
  responseMethodValue: string;
...
const copyByLocale: Record<SupportedLocale, InviteCopy> = {
  fr: copyFr,
  en: copyEn,
};

export default function FitdeskInviteFromCoachToExistingAthlete({
  locale = 'fr',
}: FitdeskInviteFromCoachToExistingAthleteProps) {
